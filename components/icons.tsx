...
export const TollIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BuildingIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 10a1 1 0 0 1 1-1" />
      <path d="M14 10a1 1 0 0 1 1-1" />
      <path d="M9 14a1 1 0 0 1 1-1" />
      <path d="M14 14a1 1 0 0 1 1-1" />
    </svg>
);
...
export const getCategoryIcon = (category: ExpenseCategory, className?: string) => {
    switch(category) {
        ...
        case ExpenseCategory.CAFE: return <CoffeeIcon className={className} />;
        ...
        case ExpenseCategory.PEDAGIO: return <TollIcon className={className} />;
