              ...
              >
                ...
                {expense.receipt ? (
                  <button
                    ...
                    className="w-16 h-16 rounded-md overflow-hidden border-2 border-gray-200 flex-shrink-0"
                    title="Ver nota fiscal"
                  >
                    <img src={expense.receipt} alt="Nota Fiscal" className="w-full h-full object-cover" />
                  </button>
                ) : (
                  <div className="w-16 h-16 rounded-md border-2 border-dashed border-gray-300 flex items-center justify-center text-xs text-gray-400 text-center flex-shrink-0">
                    Sem anexo
                  </div>
                )}
              </li>
